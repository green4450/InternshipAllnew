                ...
                <div class="row mt-4">
                    <div class="col">
                        <a href="./post_internship.php" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
							...
							<span style="margin-top:10px"class="ml-2">Post Internship</span>
					    </a>
                    </div>
					...
					<div class="col">
                        <a href="./applied.php" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
							<i class="fas fa-user-plus"></i>	
							<span style="margin-top:10px"class="ml-2">Students Applied</span>
					    </a>
                    </div>
					...
					<div class="col">
                        <a href="./applied.php" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
							<i class="fas fa-user-plus"></i>	
							<span style="margin-top:10px"class="ml-2">Chat Section</span>
					    </a>
                    </div>
                    ...
                    <div class="col">
                        <a href="./login_type.php" class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
							...
							<span style="margin-top:10px"class="ml-2">Logout</span>
					    </a>
                    </div>
                </div>
                </div>
