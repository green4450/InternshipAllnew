        ...
        <div class="container">
            <div class="row">
                ...
                <form method="post" class="text-center border border-light p-5" action="./src/php/main.php">
                    ...
                    <input type="radio" name="title" id="title" class="form-control mb-4" placeholder=" Internship Tittle">Internship 
                    <input type="radio" name="title" id="title" class="form-control mb-4" placeholder=" Internship Tittle">Graduate Job
                    <input type="radio" name="title" id="title" class="form-control mb-4" placeholder=" Internship Tittle"> Apprentership
                    <input type="radio" name="title" id="title" class="form-control mb-4" placeholder=" Internship Tittle"> Research
                    
                    <input type="textarea" name="content" id="content" class="form-control mb-4" placeholder="Internship Descritption">
